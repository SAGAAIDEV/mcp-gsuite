...
def get_gauth_file() -> str:
    return gsuite_config.client_secrets_file
...
# def get_credentials_dir() -> str: # Replaced by gsuite_config.credentials_dir
#     return gsuite_config.credentials_dir


def _get_credential_filename(user_id: str) -> str:
    # creds_dir = get_credentials_dir() # Directly use gsuite_config
    return os.path.join(gsuite_config.credentials_dir, f".oauth2.{user_id}.json")
...
def get_credentials(authorization_code, state):
    ...
    refresh token.
    Raises:
    CodeExchangeException: Could not exchange the authorization code.
